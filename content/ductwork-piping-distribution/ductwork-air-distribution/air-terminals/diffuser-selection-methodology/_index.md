...
- Room Load Cfm Calculation
- Supply Air Temperature Differential
- Air Change Rate Verification
- Throw To Room Dimension Ratio
- Throw Distance Criteria
- Characteristic Length Room
- Adpi Air Diffusion Performance Index
- Effective Draft Temperature Edt
- Local Air Velocity Comfort
- Diffuser Spacing Guidelines
- Maximum Spacing Limits
- Manufacturer Performance Data
- Application Selection Charts
- Correction Factors Temperature
- Correction Factors Mounting
