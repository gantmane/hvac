...
Nitrite ions oxidize ferrous ions at anodic sites to form protective gamma-Fe₂O₃:
...
**Protection Mechanism**
Molybdate forms protective ferric molybdate complexes:
...
**Protection Mechanism**
Organic acids form protective coordination complexes with metal surfaces:
...
Example for 1000-gallon system requiring 2500 ppm nitrite using 40% inhibitor:
2500 ppm = 0.25% by weight
Dose = 1000 × 0.0025 ÷ 0.40 = 6.25 gallons
...
| Inhibitor Type | Minimum Level | Optimal Range |
|----------------|---------------|---------------|
| Sodium Nitrite | 1200 ppm | 2000-3000 ppm |
| Molybdate | 200 ppm | 400-800 ppm |
| OAT | 0.5% | 1.0-2.0% |
| HOAT | 0.75% | 1.0-1.5% |
| Tolyltriazole (TTA) | 50 ppm | 100-200 ppm |

**Maximum Recommended Levels**
Exceeding recommended concentrations can cause:
...
**Nitrite Testing**
Standard colorimetric test strips or titration kits provide rapid field assessment:
...
Accuracy: ±10% for concentrations 500-3000 ppm
Frequency: monthly for first year, quarterly thereafter

**pH Measurement**
Critical parameter affecting inhibitor performance:
...
Indirect measure of total dissolved solids and inhibitor concentration:
...
**Complete Coolant Analysis**
Comprehensive testing provides detailed system health assessment:

| Parameter | Method | Significance |
|-----------|--------|--------------|
| Nitrite | Ion chromatography | Primary inhibitor level |
| Molybdate | ICP-OES | Alternative inhibitor level |
| pH | Electrode | Corrosion potential |
| Reserve alkalinity | Titration | Buffer capacity |
| Chloride | Ion-selective electrode | Corrosion accelerator |
| Iron | Atomic absorption | Ferrous corrosion indicator |
| Copper | Atomic absorption | Copper corrosion indicator |
| Glycol % | Refractometer | Freeze/burst protection |
...
**Coupon Testing**
Install pre-weighed metal coupons in system for direct corrosion measurement:
...
**Ferrous Metals**
Carbon steel, cast iron, ductile iron components:
...
Brass fittings, bronze pumps, copper heat exchangers:
...
**Aluminum Alloys**
Heat exchangers, evaporators, manifolds:
...
**Stainless Steel**
Austenitic grades (304, 316) in specialty applications:
...
**Galvanic Series in Inhibited Glycol**
(Anodic/least noble to cathodic/most noble)
...
| Material | Nitrite Systems | OAT Systems | HOAT Systems |
|----------|-----------------|-------------|--------------|
| EPDM | Excellent | Excellent | Excellent |
| Nitrile (Buna-N) | Good | Excellent | Good |
| Silicone | Fair | Good | Good |
| Fluoroelastomer (Viton) | Excellent | Excellent | Excellent |
| Neoprene | Good | Fair | Good |
...
For critical applications, conduct compatibility testing per ASTM D471:
...
**Reserve Alkalinity**
Measure of buffering capacity to neutralize acid formation:

Test method: Titrate sample with standardized acid to pH 4.0 endpoint
Typical values: 5-15 ml of 0.1N HCl per 10 ml sample
Low reserve alkalinity (<3 ml) indicates depleted buffering capacity

### pH Control Strategies

**Target pH Ranges by Inhibitor Type**
| Inhibitor System | Optimal pH | Acceptable Range |
|------------------|------------|------------------|
| Nitrite-based | 9.5 | 8.5-10.5 |
| Molybdate-based | 9.0 | 8.0-10.0 |
| OAT | 8.5 | 7.5-9.0 |
| HOAT | 8.5 | 7.5-9.5 |
...
**Oxidative Depletion**
Nitrite inhibitors are consumed by oxidation reactions:
...
Nitrite-reducing bacteria convert nitrite to nitrogen gas:
...
**System Leakage**
Inhibitor loss proportional to coolant volume loss:
...
Initial system startup adsorbs inhibitors onto metal surfaces:
...
**Simple Dosing Approach**
Based on measured inhibitor level:
...
**Proportional Addition Method**
Add small volumes and retest:
...
Account for all wetted components:
...
| Parameter | Maximum ppm | Impact if Exceeded |
|-----------|-------------|-------------------|
| Chloride | 25 | Accelerates pitting corrosion |
| Sulfate | 25 | Promotes bacterial growth |
| Total Dissolved Solids | 100 | Depletes inhibitors, scale formation |
| Hardness (as CaCO₃) | 50 | Scale, fouling, inhibitor precipitation |
| Iron | 0.3 | System contamination, deposits |
| Copper | 0.1 | Galvanic corrosion acceleration |
...
**ASHRAE Standard 188**
Legionellosis prevention in building water systems:
...
**ASTM D1384**
Standard Test Method for Corrosion of Heat Transfer Coolants:
...
**ASTM D3306/D4985**
Automotive coolant specifications applicable to HVAC:
- Reserve alkalinity requirements
- Corrosion inhibitor performance
- Stability and compatibility testing

**ASTM D2570**
Simulated service corrosion testing:
...
**Safety Data Sheets**
Maintain SDS for all coolant products:
...
**File Path:** `/Users/evgenygantman/Documents/github/gantmane/hvac/content/hvac-fundamentals/material-properties/secondary-coolant-properties/corrosion-inhibitors/_index.md`

This comprehensive technical document provides HVAC professionals with detailed guidance on corrosion inhibitor selection, application, testing, and maintenance for secondary coolant systems. The content emphasizes electrochemical principles, practical calculations, and compliance with industry standards.
