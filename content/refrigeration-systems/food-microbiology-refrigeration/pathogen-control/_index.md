...
|-----------|---------------|---------|
| Storage Temperature | ≤4°C (≤39°F) | Slow growth rate |
| Product pH | <4.4 | Inhibit growth |
| Water Activity | <0.92 | Limit growth |
| Shelf Life | ≤7 days at >4°C | Minimize multiplication |
...
| Temperature | Growth Rate | Control Effect |
|-------------|-------------|----------------|
| <7°C (<45°F) | No growth | Complete inhibition |
| 7-10°C (45-50°F) | Slow growth | Inadequate control |
| >10°C (>50°F) | Rapid growth | Dangerous range |
...
| Application | Target Temperature | Maximum Temperature | Rationale |
|-------------|-------------------|---------------------|-----------|
| General refrigeration | 2-4°C (36-39°F) | 5°C (41°F) | Inhibit mesophilic pathogens |
| High-risk products | 0-2°C (32-36°F) | 3°C (37°F) | Control psychrotrophs |
| Frozen storage | -18°C (0°F) | -15°C (5°F) | Complete growth inhibition |
| Ultra-low freezing | -40°C (-40°F) | -35°C (-31°F) | Long-term quality preservation |
...
At 10°C (50°F), pathogen may double every 2 hours.
At 20°C (68°F), same pathogen doubles every 40-60 minutes.
At 4°C (39°F), doubling time extends to days or weeks.

### Time-Temperature Limits

**FDA Food Code Requirements:**

| Scenario | Maximum Time | Temperature Limit |
|----------|--------------|-------------------|
| Cooling (hot to cold) | 2 hours | 60-20°C (140-68°F) |
| Cooling (continued) | 4 hours | 20-5°C (68-41°F) |
| Cold holding | Unlimited | ≤5°C (≤41°F) |
| Room temperature display | 4 hours | Discard after |
...
| Hazard Type | Examples | Severity | Likelihood |
|-------------|----------|----------|------------|
| Pathogenic bacteria | Listeria, Salmonella, E. coli | High | Medium |
| Toxin-forming bacteria | C. botulinum, S. aureus | High | Low |
| Viruses | Norovirus, Hepatitis A | High | Low |
| Parasites | Trichinella, Anisakis | Medium | Low |
...
| CCP | Critical Limit | Measurement | Frequency |
|-----|----------------|-------------|-----------|
| Receiving | ≤5°C (≤41°F) | Product core temp | Each delivery |
| Cold storage | ≤4°C (≤39°F) | Air temperature | Continuous |
| Cooling | 60-20°C in 2 hr | Product core temp | Each batch |
| Cold display | ≤7°C (≤45°F) | Product surface | Every 4 hours |
...
| Deviation | Immediate Action | Product Disposition | Process Correction |
|-----------|------------------|---------------------|-------------------|
| Storage temp >5°C | Move to working cooler | Hold and test | Repair refrigeration |
| Cooling time exceeded | Rapid chill in blast | Discard if >6 hours | Reduce batch size |
| Receiving temp >7°C | Reject shipment | Return to supplier | Review supplier |
...
| Hurdle 1 | Hurdle 2 | Hurdle 3 | Application | Pathogen Target |
|----------|----------|----------|-------------|-----------------|
| 4°C storage | pH 5.5 | 2% NaCl | Deli salads | Listeria |
| 2°C storage | Vacuum pack | Lactate | RTE meats | Listeria |
| 4°C storage | CO₂ MAP | Low pH | Seafood | C. botulinum type E |
| 0°C storage | 3% salt | Smoke | Salmon | Listeria |
