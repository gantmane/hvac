...
1. Packaging rooms: Highest pressure (reference +0.03 in w.c.)
2. Cutting floor: Intermediate pressure (reference +0.02 in w.c.)
3. Breaking room: Neutral pressure (reference point)
4. Rendering/waste areas: Negative pressure (reference -0.02 in w.c.)
