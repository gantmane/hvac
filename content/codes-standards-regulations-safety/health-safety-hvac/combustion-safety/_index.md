...
| CO Concentration (ppm) | Exposure Duration | Physiological Effects |
|----------------------|-------------------|---------------------|
| 9 | 8 hours | Maximum allowable exposure per OSHA for healthy adults |
| 35 | 8 hours | Headache and dizziness in sensitive individuals |
| 70 | 1-4 hours | Headache, fatigue, nausea |
| 100 | 2 hours | Headache; 4 hours = serious symptoms |
| 150-200 | 2 hours | Disorientation, unconsciousness |
| 400 | 1-2 hours | Serious symptoms; 3 hours = life threatening |
| 800 | 45 minutes | Dizziness, nausea; 2 hours = unconsciousness |
| 1,600 | 20 minutes | Headache, dizziness; 2 hours = death |
| 3,200 | 5-10 minutes | Headache, dizziness; 30 minutes = death |
| 6,400 | 1-2 minutes | Headache, dizziness; 15 minutes = death |
| 12,800 | 1-3 minutes | Unconsciousness, death |

**Carboxyhemoglobin Formation:**
CO has approximately 200-250 times greater affinity for hemoglobin than oxygen, meaning even low CO concentrations can significantly reduce oxygen-carrying capacity. COHb percentage correlates with symptoms:
...
**UL 2034 Standard:**
Underwriters Laboratories Standard 2034 establishes performance requirements for residential CO alarms including:
...
National Fire Protection Association (NFPA) and International Residential Code (IRC) require CO alarms:
...
Building codes increasingly require:
...
Requires CO monitoring in buildings with attached parking garages, with specific trigger levels:
- Alarm when CO exceeds 25 ppm
- Increase ventilation when CO exceeds 10 ppm

**Machinery Room Monitoring:**
Combustion equipment in machinery rooms should include continuous CO monitoring with:
...
Advanced commercial systems integrate CO detection with:
...
Complete combustion requires precise fuel-to-air ratios. For natural gas (primarily methane):
...
Real-world combustion requires excess air beyond stoichiometric for:
...
**Example:**
200,000 Btu/hr total appliance input
Required volume: 200 × 50 = 10,000 ft³

If building volume exceeds 10,000 ft³, no additional combustion air required.

**Outdoor Combustion Air:**
When building volume is insufficient, provide outdoor air through:
...
Systems may provide combustion air through mechanical ventilation:
...
**Draft Fundamentals:**
Natural draft occurs due to buoyancy of hot flue gases being less dense than surrounding air:
...
**Backdrafting Definition:**
Reverse flow in venting system where combustion products spill into building rather than exhausting outdoors.

**Spillage Definition:**
Temporary or sustained flow of combustion products from draft hood or draft regulator into building space.
