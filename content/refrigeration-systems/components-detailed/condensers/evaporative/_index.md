...
|-----------|--------------|-------|
| Evaporation | 1.8 gpm/MBH | Function of heat rejection |
| Blowdown | 0.3-0.6 gpm/MBH | Maintains water quality |
| Drift | <0.002% of circulation | Minimized by eliminators |
...
| Parameter | Evaporative Condenser | Tower + Water-Cooled |
|-----------|---------------------|---------------------|
| Condensing temp approach | 10-15°F to WB | 15-20°F to WB |
| Pumping power | Single pump | Tower pump + condenser pump |
| Heat exchangers | Single unit | Tower + condenser |
| Refrigerant charge | Lower | Higher |
| Footprint | Compact | Distributed |
