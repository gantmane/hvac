...
seo_description: "Complete guide to union HVAC apprenticeships including United Association pipefitters, sheet metal workers, and electricians programs with wage progression and certification requirements."
---
...
```mermaid
gantt
    title Union Apprenticeship Progression
    dateFormat YYYY
    section Year 1
    Basic Safety & Tools           :2024, 1y
    Blueprint Reading              :2024, 1y
    section Year 2
    Fundamental Systems            :2025, 1y
    Code Requirements              :2025, 1y
    section Year 3
    Advanced Installation          :2026, 1y
    System Commissioning           :2026, 1y
    section Year 4
    Troubleshooting Methods        :2027, 1y
    Energy Management              :2027, 1y
    section Year 5
    Project Leadership             :2028, 1y
    Journeyman Exam Prep           :2028, 1y
```
...
```mermaid
graph TD
    A[10,000 Total Hours] --> B[Installation - 4,000 hrs]
    A --> C[Service/Repair - 2,500 hrs]
    A --> D[Fabrication - 1,500 hrs]
    A --> E[Testing/Commissioning - 1,000 hrs]
    A --> F[Administrative/Layout - 1,000 hrs]

    B --> B1[Piping Systems]
    B --> B2[Equipment Setting]
    B --> B3[Control Installation]

    C --> C1[Troubleshooting]
    C --> C2[Component Replacement]
    C --> C3[System Optimization]

    D --> D1[Pipe Threading/Cutting]
    D --> D2[Welding/Brazing]
    D --> D3[Hanger Fabrication]
```
