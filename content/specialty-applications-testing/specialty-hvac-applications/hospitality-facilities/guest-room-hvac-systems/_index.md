...
| Performance Metric | Value Range | Design Impact |
|-------------------|-------------|---------------|
| Cooling Capacity | 7,000-15,000 Btu/hr | Match to room load |
| Heating Capacity | 8,000-18,000 Btu/hr | Size for envelope loss |
| Noise Level | 42-48 dBA | NC 35-40 equivalent |
| Air Flow Rate | 250-400 CFM | Provides air motion |
| Power Consumption | 1.0-2.0 kW cooling | Electrical infrastructure |
| Unit Life Expectancy | 8-12 years | Replacement planning |
...
| System Type | First Cost | Energy Cost | Maintenance | Noise Level | Comfort Control |
|-------------|-----------|-------------|-------------|-------------|-----------------|
| PTAC | $ | $$ | Simple | 42-48 dBA | ±2°F |
| 2-Pipe FCU | $$ | $ | Moderate | 35-40 dBA | ±1.5°F |
| 4-Pipe FCU | $$$ | $ | Moderate | 35-40 dBA | ±1°F |
| VRF | $$$$ | $ | Specialized | 28-35 dBA | ±0.5°F |
