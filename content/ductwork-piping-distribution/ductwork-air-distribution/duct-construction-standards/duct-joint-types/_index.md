...
```mermaid
graph TD
    A[Determine Static Pressure] --> B{Pressure Range?}
    B -->|< 2 in. w.g.| C[Low Pressure System]
    B -->|2-4 in. w.g.| D[Medium Pressure System]
    B -->|> 4 in. w.g.| E[High Pressure System]

    C --> C1[Slip Joints with Sealant]
    C --> C2[Standing Seams]
    C --> C3[Light-Duty Flanges]

    D --> D1[Flat Strap Flanges]
    D --> D2[TDC/Ductmate Flanges]
    D --> D3[Full Gasket Sealing]

    E --> E1[Angle Iron Flanges]
    E --> E2[Welded Connections]
    E --> E3[Companion Angle Flanges]
