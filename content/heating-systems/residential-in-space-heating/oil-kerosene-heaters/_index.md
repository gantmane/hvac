...
Stoichiometric air-fuel ratio: 15:1 by mass
...
**Sulfur Content**
Premium grade kerosene: <0.04% sulfur (400 ppm max)
Standard grade: <0.3% sulfur
...
**Water Contamination**
Water accumulation from condensation promotes microbial growth. Weekly or monthly tank bottom sampling recommended. Water content >0.05% indicates contamination requiring fuel polishing or replacement.

**Sediment and Particulates**
Fuel filtration critical for proper burner operation:
...
**Operating Principle**
Fuel drips or flows into combustion pot where vaporization and burning occur. Simple, reliable design with minimal moving parts.

**Burner Types**

**Sleeve Burner**
Fuel flows down center sleeve into pot. Air enters through adjustable primary air ports at pot base and secondary air ports in burner throat.

Heat output: 25,000-50,000 BTU/hr
Efficiency: 65-72%
Typical for floor-mounted cabinet heaters

**Pot-Type Vaporizing Burner**
Fuel pools in cast iron pot heated by flame. Vaporized fuel mixes with combustion air above liquid surface.

Heat output: 15,000-40,000 BTU/hr
Efficiency: 60-70%
Used in portable vented heaters
...
Primary air controls yellow vs. blue flame appearance:
...
**Atomizing Burner Design**
High-pressure pump (100-140 psi) forces oil through nozzle, creating fine spray. Blower provides combustion air in proper ratio. Electric ignition (spark or interrupted pilot) initiates combustion.
...
High-voltage output: 10,000-14,000 volts
Creates spark across electrodes positioned in fuel spray cone
Spark gap: 1/8 to 5/32 inch

### Efficiency and Emissions

**Steady-State Efficiency**
Gun burner vented heaters achieve 78-85% efficiency through:
...
Proper atomization and air mixing minimize soot:
...
**Venting Systems**
Type L vent (listed oil-burning appliance vent) required:
...
| Component | Clearance |
|---|---|
| Rear wall | 12-24 inches |
| Side walls | 12-18 inches |
| Ceiling | 24-36 inches |
...
**Wick-Type Design**
Cylindrical or flat woven fiberglass wick draws kerosene by capillary action from reservoir to combustion zone. Air enters through bottom vents, passes through flame, and exits top grille by natural convection.
...
**Construction**
Circular wick surrounds central air tube. Combustion occurs at wick top, heating refractory or wire mesh element to 1,400-1,800°F. Hot surface emits infrared radiation.
...
Polished metal reflector behind heating element directs radiation forward:
...
**Tip-Over Shutoff**
Gravity-actuated or pendulum switch:
...
Flame detector (thermocouple or photocell) monitors combustion:
- If ignition fails within 45-60 seconds, fuel shuts off
- Prevents unburned fuel accumulation
- Manual reset required

**Overheat Protection**
Bimetal thermostat monitors cabinet temperature:
...
**Emissions Without Venting**
23,000 BTU/hr kerosene heater operating 8 hours produces:
- CO₂: 18.5 lb (3,600 ft³)
...
**Fuel Testing**
Color test: Water-clear to pale yellow acceptable
Sniff test: Mild petroleum odor; strong or pungent indicates contamination
Burn test: Clean blue flame with minimal smoke
...
For 0.2% sulfur fuel at 0.7 GPH consumption:
SO₂ production = 0.0028 lb/hr = 21 ppm in 1,000 ft³ space with 0.5 ACH
