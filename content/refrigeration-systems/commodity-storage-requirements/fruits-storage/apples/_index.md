...
1. **Catalytic Oxidation**: Platinum or palladium catalyst at 150-300°C converts ethylene to CO₂ and H₂O. Removes 95-99% of ethylene with 200-400 air changes per day.

2. **Potassium Permanganate Scrubbers**: Chemical oxidation removes ethylene but requires regular media replacement (every 3-6 months). Capacity: 1 kg KMnO₄ removes approximately 100 L ethylene.

3. **Ozone Treatment**: 0.05-0.3 ppm ozone oxidizes ethylene and reduces surface microorganisms. Must be carefully controlled to prevent fruit injury.

4. **1-Methylcyclopropene (1-MCP)**: Blocks ethylene receptors. Applied at 300-625 ppb for 12-24 hours post-harvest. Extends storage life 2-4 months for responsive varieties.
