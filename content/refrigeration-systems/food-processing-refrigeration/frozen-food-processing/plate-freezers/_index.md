...
|-----------|---------------|-------|
| Plate temperature | -35 to -45°C | Refrigerant evaporation temperature |
| Contact pressure | 2-10 bar | Adjustable based on product |
| Heat transfer coefficient | 200-400 W/(m²·K) | With good contact |
| Freezing time (50 mm product) | 1.5-3 hours | Product dependent |
| Refrigeration capacity | 10-50 kW per station | Varies with plate size |
| Energy consumption | 0.15-0.25 kWh/kg | Product frozen |
...
| Refrigerant | Evap Temp | Advantages | Disadvantages |
|-------------|-----------|------------|---------------|
| Ammonia (R-717) | -40 to -45°C | High efficiency, low cost | Toxicity, regulations |
| R-404A | -40 to -45°C | Easy handling, safety | High GWP (3922), phaseout |
| R-448A | -40 to -45°C | Lower GWP (1387) | Higher cost |
| R-744 (CO2) | -45 to -50°C | Natural, low GWP | High pressure system |
...
|-----------|-------|-------------------|
| Product thickness | 20-150 mm | Optimal: 40-80 mm |
| Freezing time | 1-6 hours | Thickness and product dependent |
| Throughput capacity | 500-10,000 kg/hr | System size dependent |
| Refrigeration capacity | 50-500 kW | Per freezer unit |
| Plate temperature | -35 to -50°C | Lower for rapid freezing |
| Contact pressure | 2-10 bar | Product specific |
| Overall HTC | 150-400 W/(m²·K) | With good contact |
| Coefficient of performance | 1.0-1.5 | At -40°C evaporation |
| Specific energy consumption | 0.12-0.30 kWh/kg | Product and conditions dependent |
| Floor space per ton/day | 2-5 m²/(ton/day) | Efficient footprint |
