...
**Advantages**: Low cost, low pressure drop
**Limitations**: Poor efficiency for respirable particles
...
**Advantages**: Good efficiency-to-pressure-drop ratio, extended surface area
**Limitations**: May require frame modifications for upgrade
...
**Advantages**: Excellent particle removal, including bacteria
**Limitations**: Higher pressure drop, requires compatible system design
...
**Advantages**: Maximum particle removal efficiency
**Limitations**: High pressure drop, specialized installation required
