...
| Parameter | Integrated HPWH | Split HPWH |
|-----------|----------------|------------|
| Rated COP (67°F ambient) | 2.5-3.5 | 2.8-3.8 |
| Capacity at Rating Point | 2500-4500 Btu/hr | 9000-18,000 Btu/hr |
| Cold Climate Performance (20°F) | Poor (requires indoor installation) | Moderate to good (climate-dependent model) |
| Impact on Space Conditioning | Significant (cooling/dehumidification) | None (outdoor unit) |
| Installation Complexity | Low | Moderate to high |
| First Cost | $1200-2500 | $2500-5000 installed |
| Maintenance Access | Limited (integrated package) | Good (separate components) |
