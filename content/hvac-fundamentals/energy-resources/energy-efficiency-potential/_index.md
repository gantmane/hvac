...
**Technical Approach:**
Chiller plant optimization follows the relationship:
...
RTU efficiency depends on integrated energy efficiency ratio (IEER), which accounts for part-load performance:
...
Boiler efficiency correlates directly with stack temperature and excess air:
...
Fan power follows affinity laws, creating cubic relationship with flow:
...
**Decision Rule:**
Implement all measures with NPV greater than 0 at specified discount rate.
...
**Application:**
Compare IRR to minimum acceptable rate of return (MARR):
...
Rank measures by SIR to maximize savings under capital constraints.
...
**Decision Criterion:**
Implement measures where LCOE is less than current energy cost, accounting for expected escalation.
...
ASHRAE Guideline 14 specifies maximum calibration error:
...
Quantify probability distribution of financial metrics accounting for uncertainty in key parameters.
