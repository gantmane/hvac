...
```mermaid
graph TD
    A[Government Budget Allocation] --> B{Subsidy Mechanism}
    B --> C[Consumer Rebate<br/>20-40% of cost]
    B --> D[Manufacturer Incentive<br/>Per unit payment]
    B --> E[Utility Program<br/>On-bill financing]

    C --> F[Retail Purchase]
    D --> G[Factory Production]
    E --> H[Installation]

    F --> I[Market Transformation]
    G --> I
    H --> I

    I --> J[Reduced National<br/>Energy Demand]
    I --> K[Improved Grid<br/>Reliability]
    I --> L[Economic<br/>Development]
```
