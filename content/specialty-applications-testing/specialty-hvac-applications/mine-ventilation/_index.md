...
keywords:
  ...
  - methane dilution ventilation
  - MSHA ventilation regulations
  - diesel particulate matter control
  - mine airway design
  - mine heat stress control
  - booster fans mining
  - ventilation on demand mining
---
...
|---------------|-------------|------------|
| Exhaust (most common) | Pulling mode | Prevents surface air short-circuiting, pressurizes returns for better leak control |
| Blowing | Pushing mode | Distributes fresh air uniformly, limited by short-circuit potential |
| Push-Pull | Complex mines | Maximum airflow, requires sophisticated control |
