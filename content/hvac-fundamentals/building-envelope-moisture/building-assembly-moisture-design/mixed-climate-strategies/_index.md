...
**Heating Degree Days**: 1800-3600 HDD65°F
**Cooling Degree Days**: 1800-2500 CDD50°F
...
**Heating Degree Days**: 3600-5400 HDD65°F
**Cooling Degree Days**: 900-1800 CDD50°F
...
**Heating Degree Days**: 5400-7200 HDD65°F
**Cooling Degree Days**: 600-1200 CDD50°F
...
Interior pv = 0.127 in. Hg
Exterior pv = 0.027 in. Hg
**Outward vapor drive**: Δpv = 0.100 in. Hg
...
Interior dewpoint at 70°F, 35% RH = 42.0°F
Sheathing (31.4°F) < dewpoint (42.0°F) → **potential condensation risk**
...
Exterior pv = 1.14 in. Hg
**Inward vapor drive**: Δpv = 0.77 in. Hg
...
Surface (75.45°F) >> dewpoint (55°F) → **no condensation**
...
**Verification**:
Net drying must exceed net accumulation over annual cycle.
...
- [Climate Zone Specific Design](./climate-zone-specific-design/) - Detailed requirements by IECC zone
- [Balanced Drying](./balanced-drying/) - Bidirectional moisture transport analysis
- [Semi-Permeable Assemblies](./semi-permeable-assemblies/) - Class III vapor retarder design
- [Mixed Climate Wall Systems](./mixed-climate-wall-systems/) - Specific assembly configurations
