...
```mermaid
graph TD
    A[Traditional RPS<br/>2000-2010] --> B[Enhanced RPS<br/>2010-2015]
    B --> C[Clean Energy Standards<br/>2015-2020]
    C --> D[100% Clean Energy Mandates<br/>2020-2030]
    D --> E[Net-Zero Grid Operations<br/>2030-2050]

    A -->|Renewable<br/>Technologies Only| F[Solar, Wind,<br/>Hydro, Biomass]
    B -->|Carve-outs &<br/>Multipliers| G[Distributed Solar,<br/>Offshore Wind]
    C -->|Technology<br/>Neutrality| H[Nuclear, CCS,<br/>All Renewables]
    D -->|Emission-based<br/>Targets| I[Zero Carbon<br/>by 2040-2050]
    E -->|Grid Integration<br/>Requirements| J[Storage, DR,<br/>Transmission]
