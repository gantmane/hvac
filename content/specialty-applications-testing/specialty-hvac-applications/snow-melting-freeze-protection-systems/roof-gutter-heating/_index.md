...
|-----------|---------------|
| Power output range | 3-12 W/ft depending on temperature |
| Maximum exposure temp | 150°F continuous, 185°F intermittent |
| Response time | 5-15 minutes for power adjustment |
| Nominal voltage | 120V or 240V configurations |
...
| Parameter | Specification |
|-----------|---------------|
| Power output | 5, 8, 10, or 12 W/ft fixed |
| Maximum exposure temp | 250°F (MI cable), 185°F (polymer) |
| Temperature uniformity | ±5% along length |
| Nominal voltage | 120V, 208V, 240V, or 277V |
