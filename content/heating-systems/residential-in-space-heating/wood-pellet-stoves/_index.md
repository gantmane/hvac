...
date: "2026-01-04"
weight: 4
tags: ["wood stove", "pellet stove", "biomass heating", "EPA certification", "wood burning", "catalytic combustor"]
...
Ceramic honeycomb coated with platinum or palladium catalyzes combustion of smoke and volatiles at temperatures as low as 500-600°F instead of typical 1,000-1,200°F required for secondary combustion.
...
**Combustion Process**
Smoke gases bypass catalyst during startup (bypass damper open). Once stove reaches 500°F, close bypass to route gases through catalyst:
...
Preheated air injected above fuel load ignites smoke and volatiles in controlled pattern. Baffles direct gases through high-temperature zone for complete combustion.

**Design Features**

**Air Injection Tubes**
Stainless steel tubes with holes positioned above firebox:
...
**Refractory Baffles**
Insulated firebox walls and baffle plates:
...
Single or multiple air controls regulate:
...
**Critical Parameter**
Wet wood reduces efficiency and increases creosote formation. Moisture content by weight:

$$MC = \frac{m_{water}}{m_{dry}} \times 100\%$$

**Performance Impact**

| Moisture Content | Efficiency Penalty | Creosote Risk |
|---|---|---|
| <20% (seasoned) | 0-5% | Low |
| 20-30% | 10-20% | Moderate |
| 30-40% | 20-30% | High |
| >40% (green) | 30-45% | Very high |

**Energy Loss from Moisture**
Heat of vaporization: 970 BTU/lb water
For 30% moisture content wood:
...
**Energy Density**
Varies by species density and resin content:

| Species | Density (lb/ft³) | Heat Content (MMBTU/cord) | Burn Rate |
|---|---|---|---|
| Oak, white | 47 | 25.7 | Slow |
| Maple, sugar | 44 | 24.0 | Moderate |
| Ash, white | 43 | 23.6 | Moderate |
| Birch, yellow | 43 | 21.8 | Fast |
| Pine, white | 25 | 15.9 | Fast |
...
Smoke contains unburned volatiles:
...
Sawdust, wood chips, or agricultural biomass compressed under high pressure without binders. Lignin in wood acts as natural binding agent.
...
Auger screw conveys pellets from hopper to burn pot:
...
For desired heat output:

$$\dot{m}_{pellets} = \frac{Q_{output}}{\eta \cdot HV_{pellets}}$$
...
30,000 BTU/hr output at 80% efficiency:
$\dot{m}_{pellets} = 30,000 / (0.8 × 8,500) = 4.4$ lb/hr
...
Delivers primary air to burn pot:
- Airflow: 50-150 CFM
...
**Convection Blower**
Distributes heat to room:
- Airflow: 80-200 CFM
- Temperature-activated or continuous operation
- Noise level: 35-50 dBA

**Air-Fuel Ratio Control**
Modern pellet stoves modulate both fuel and air:
...
**Ash Production**
Premium pellets: 0.5-1% ash by weight
Standard pellets: 1-3% ash by weight

For 4 lb/hr consumption over 8-hour burn:
Premium: 0.16-0.32 lb ash per day
Standard: 0.32-0.96 lb ash per day
...
**Clinker Formation**
High-ash pellets or contaminated fuel creates fused ash deposits:
...
**Code Requirements**
NFPA 211 recommends outside combustion air for:
...
For 75,000 BTU/hr stove: $A_{duct} = 75,000/4,000 = 18.75$ in²
Use 5-inch round duct (19.6 in² area)
...
**Pressure Effects**
Exhaust fans, fireplaces, and leaky ductwork create negative pressure:
...
| Ceiling | 84 inches minimum |
| Corner (behind stove) | 12 inches from corner |
| Stovepipe to wall | 18 inches |
| Stovepipe to ceiling | 18 inches |

**Listed Clearances**
Manufacturer testing may demonstrate reduced clearances:
...
**Wall Shields**
Ventilated air space between shield and combustible wall:
...
For 36-inch standard clearance with 50% reduction:
$C_r = 36 × 0.50 = 18$ inches minimum

**Spacer Requirements**
Non-combustible spacers maintain air gap:
...
Some listings specify thermal resistance:
...
Chimney must match stove flue collar size or specific listing:
...
For 20-foot chimney, 0°F outdoor, 400°F flue gas:
$\Delta P = 0.0254 × 20 × (1/460 - 1/860) = 0.0262$ inches w.c.
...
**Class A Chimney**
Listed factory-built double or triple wall:
...
**Masonry Chimney with Liner**
Clay tile or stainless steel liner required:
...
**Stovepipe**
Single-wall connector from stove to chimney:
...
**HHV vs. LHV Basis**
Wood stove efficiency typically reported on HHV (higher heating value) basis:
...
**Pellet Stove Modulation**
Automatic fuel and air adjustment:
...
**Ignition Risk**
Third-degree creosote ignites at 451°F:
...
**Top-Down Fire**
Reduces smoke and creosote during startup:
