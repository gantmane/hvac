...
```mermaid
graph TB
    A[Unitary HVAC Systems] --> B[Packaged Systems]
    A --> C[Split Systems]

    B --> D[Rooftop Units RTU]
    B --> E[Ground-Mounted Package]
    B --> F[PTAC/PTHP]
    B --> G[Portable Units]

    C --> H[Residential Split]
    C --> I[Commercial Split]
    C --> J[Mini-Split Ductless]
    C --> K[Multi-Split Systems]
