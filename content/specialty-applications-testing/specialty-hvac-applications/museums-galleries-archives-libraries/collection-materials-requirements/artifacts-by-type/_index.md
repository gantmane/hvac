...
```mermaid
graph TB
    A[Gallery Environment<br/>20°C, 50% RH] --> B[Metal Artifacts Case<br/>Silica gel buffering<br/>35% RH]
    A --> C[Wood Artifacts Display<br/>Gallery conditions<br/>50% RH]
    A --> D[Composite Artifacts Case<br/>Active conditioning<br/>45% RH]
    A --> E[Ivory Objects Case<br/>Precision buffering<br/>50% ±1% RH]

    B --> F[Bronze sculptures<br/>Stable patina]
    C --> G[Wood carvings<br/>Dimensional stability]
    D --> H[Lacquer boxes<br/>Multi-material preservation]
    E --> I[Ivory carvings<br/>Crack prevention]

    J[HVAC System] --> A
    K[Desiccant modules] --> B
    K --> D
    L[Silica gel cassettes] --> E
