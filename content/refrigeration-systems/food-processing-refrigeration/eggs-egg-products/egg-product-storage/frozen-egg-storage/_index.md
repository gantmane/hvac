...
Recommended: 15 to 25 air changes per hour for occupied zones
Low air movement zones: 8 to 12 air changes per hour acceptable
...
Q_evap = 3.75 kg/s × 1.006 kJ/(kg·K) × (-18°C - (-26°C))
Q_evap = 3.75 × 1.006 × 8 = 30.2 kW (103,000 Btu/h)
...
Q_sensible_1 = 5000 kg/day × 3.5 kJ/(kg·K) × (4°C - (-0.5°C)) / 86,400 s/day
Q_sensible_1 = 0.91 kW

Q_latent = 5000 kg/day × 280 kJ/kg / 86,400 s/day
Q_latent = 16.2 kW

Q_sensible_2 = 5000 kg/day × 1.9 kJ/(kg·K) × (-0.5°C - (-20°C)) / 86,400 s/day
Q_sensible_2 = 1.07 kW
