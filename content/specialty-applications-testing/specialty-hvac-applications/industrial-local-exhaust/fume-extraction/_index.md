...
| Process | Fume Rate (mg/min) | Particle Characteristics |
|---------|-------------------|-------------------------|
| SMAW (Stick) | 200-600 | High generation, coarse particles |
| GMAW (MIG) | 100-400 | Moderate generation, fine particles |
| FCAW | 300-800 | Highest generation rate |
| GTAW (TIG) | 20-80 | Low generation, very fine particles |
| Plasma Cutting | 500-2000 | Extremely high generation |
