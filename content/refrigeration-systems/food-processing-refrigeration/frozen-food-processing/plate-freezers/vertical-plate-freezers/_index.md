...
Initial fish temperature: 0 to +4°C (chilled)
Plate surface temperature: -35 to -42°C
Final product core temperature: -18°C minimum (typically -20 to -25°C)
...
t = 8,055 × (0.000167 + 0.0000025)
t = 8,055 × 0.000169
t ≈ 1.37 seconds per J/(kg·K) → approximately 2.1 hours
...
With 3-hour cycle time and 20-hour operation:
Daily capacity = (1,800 kg / 3 hr) × 20 hr = 12,000 kg/day
...
Q_product = 1,800 × (3.8 × 3.5 + 280 + 1.9 × 18.5)
Q_product = 1,800 × (13.3 + 280 + 35.2)
Q_product = 1,800 × 328.5 = 591,300 kJ per cycle
