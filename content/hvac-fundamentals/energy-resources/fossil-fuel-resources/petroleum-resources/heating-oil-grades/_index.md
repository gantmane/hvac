...
```mermaid
graph TD
    A[Heating Oil Selection] --> B{Application Size}
    B -->|< 1 MMBtu/hr| C{Climate Conditions}
    B -->|1-10 MMBtu/hr| D[No. 2 Standard]
    B -->|10-50 MMBtu/hr| E{Fuel Handling Capability}
    B -->|> 50 MMBtu/hr| F{Economic Analysis}

    C -->|Extreme Cold| G[No. 1 or Kerosene]
    C -->|Moderate| H[No. 2 Standard]

    E -->|Basic Equipment| I[No. 2 Standard]
    E -->|Preheat Available| J[No. 4 Light]

    F -->|Minimal Investment| K[No. 4 or No. 5]
    F -->|Full Fuel System| L[No. 5 Heavy or No. 6]

    G --> M[Verify ASTM D396 Grade 1]
    H --> N[Verify ASTM D396 Grade 2]
    I --> N
    D --> N
    J --> O[Verify ASTM D396 Grade 4]
    K --> P[Verify ASTM D396 Grade 4/5]
    L --> Q[Verify ASTM D396 Grade 5/6]
```
