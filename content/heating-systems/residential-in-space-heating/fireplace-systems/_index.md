...
date: "2026-01-04"
weight: 5
tags: ["fireplace", "masonry fireplace", "fireplace insert", "direct vent fireplace", "gas fireplace", "wood fireplace"]
...
**Radiant Heat**
Direct infrared radiation from fire and heated firebrick:
...
**Convective Loss**
Combustion air consumption dominates energy balance:
...
**Net Heat Contribution**
For traditional open fireplace:
...
**Improved Geometry**
Count Rumford (1796) optimized proportions for radiant heat:
...
**Modern Applications**
Rumford proportions applied to new masonry construction:
- Width: 36-48 inches
- Height: 32-42 inches
- Depth: 12-18 inches
...
Direct connection to outdoor air reduces room air consumption:
...
**Airflow Control**
Glass doors with adjustable air inlets:
...
**Net Efficiency**
With doors closed during combustion:
...
**Post-Fire Operation**
Doors closed after fire extinguished:
...
Double-wall firebox with air space:
...
**Heat Output**
Circulating air provides convective heat:

$$Q_{circ} = \dot{m}_{air} c_p (T_{out} - T_{in})$$

Typical airflow: 100-300 CFM
Temperature rise: 80-120°F
Convective output: 12,000-30,000 BTU/hr

**Combined Heat Delivery**
...
**UL 127 Standard**
Factory-built fireplaces tested to:
...
Insert fits into existing masonry or factory-built fireplace:
...
Achieve wood stove efficiency levels:
...
Essential for safe insert operation:
...
Liner cross-section should not be less than insert outlet:
...
**Operating Principle**
Completely isolated from indoor air:
...
**Unvented Operation**
Similar to unvented gas heaters but fireplace configuration:
...
**Efficiency**
Near-theoretical: 99% fuel-to-heat conversion
All combustion products released indoors (CO₂, H₂O, trace CO)
...
**Heating Elements**
Quartz or metal sheath resistance heaters:
...
**Clearances for Factory-Built**
Follow listing specifications (typically):
...
**Height and Draft**
Adequate draft essential for proper operation:
