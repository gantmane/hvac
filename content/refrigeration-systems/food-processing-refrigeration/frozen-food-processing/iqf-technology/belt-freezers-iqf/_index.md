...
Product: 10mm diced vegetables
Freezing time required: 6 minutes (360 seconds)
Belt speed: 2.5 m/min (0.0417 m/s)
Required belt length: 0.0417 × 360 = 15 m
...
1. **Production capacity requirements** (kg/hr)
2. **Product characteristics** (size, shape, moisture)
3. **Available floor space** and building height
4. **Upstream and downstream integration** points
5. **Energy cost** and efficiency priorities
