...
|-------|--------|------------------|
| Programming | 5-10% | Requirements document |
| Schematic Design | 15-20% | System concepts, single-lines |
| Design Development | 25-30% | Equipment sizing, layouts |
| Construction Documents | 35-40% | Complete bid documents |
| Construction Administration | 10-15% | Submittals, field support |
...
| Document | Content |
|----------|---------|
| SD Report | System narratives, basis of design |
| Floor Plans | Equipment locations, major routing |
| System Diagrams | Single-line flow diagrams |
| Equipment List | Preliminary sizing |
| Code Summary | Applicable standards |
...
| Document | Content |
|----------|---------|
| DD Drawings | Scaled floor plans, sections |
| Equipment Schedules | Sized equipment data |
| Control Diagrams | System schematics |
| Specifications | Outline specs |
| Energy Report | Code compliance, analysis |
