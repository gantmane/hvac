...
```mermaid
graph TB
    A[ISO TC 86<br/>Refrigeration & AC] --> B[Regional Standards Bodies]
    B --> C[ASHRAE]
    B --> D[REHVA/CEN]
    B --> E[AIRAH/SAI]
    B --> F[Asian Bodies]

    C --> G[Technical Committees<br/>150+ TCs & SSPCs]
    D --> H[REHVA Task Forces<br/>Technology Groups]
    E --> I[Technical Panels]
    F --> J[National Standards<br/>Development]

    G --> K[Standards Publication<br/>ASHRAE 15, 34, 62, 90]
    H --> L[EN Standards Support<br/>CEN TC 156, TC 113]
    I --> M[AS/NZS Standards]
    J --> N[JIS, GB, IS Standards]

    K --> O[International Collaboration<br/>Harmonization Initiatives]
    L --> O
    M --> O
    N --> O
```
...
```mermaid
graph LR
    A[Global Standards<br/>Harmonization] --> B[Refrigerant Safety<br/>ISO 817 / ASHRAE 34]
    A --> C[Energy Performance<br/>ISO 50001]
    A --> D[Indoor Air Quality<br/>ISO 16814]

    E[Technology Transfer] --> F[Emerging Markets<br/>Support Programs]
    E --> G[Research Sharing<br/>Joint Projects]

    H[Climate Action] --> I[Montreal Protocol<br/>Refrigerant Phase-down]
    H --> J[Paris Agreement<br/>Building Decarbonization]

    B --> K[Unified Global<br/>Approach]
    C --> K
    D --> K
    F --> K
    G --> K
