...
**Advantages**: Compact, economical, quiet at design point
**Limitations**: Unstable left of peak, not for dirty air
...
**Advantages**: High efficiency, non-overloading power
**Limitations**: Higher first cost, limited particle tolerance
...
**Advantages**: Handles particulates, high pressure capability
**Limitations**: Lower efficiency, higher noise
...
**Advantages**: Simple, economical, high airflow
**Limitations**: Very low pressure capability
...
**Advantages**: Compact, good volume/pressure balance
**Limitations**: Air swirl without straightener
...
**Advantages**: High efficiency, compact, adjustable pitch available
**Limitations**: Higher cost, noise at off-design
