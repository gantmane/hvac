...
1. Ice crystal mechanical stress
2. Solute concentration effects (freeze concentration)
3. pH shifts in unfrozen phase
...
Colorimetric measurements (CIE L*a*b* system) demonstrate:
...
- Color measurement: CIE L*a*b* colorimetry, HunterLab protocols
