...
```mermaid
flowchart TD
    A[Fall Hazard Identified] --> B{Can hazard be eliminated?}
    B -->|Yes| C[Eliminate: Work from ground level<br/>Use cranes/lifts for equipment]
    B -->|No| D{Can passive protection be used?}
    D -->|Yes| E[Passive Systems:<br/>Guardrails<br/>Hole covers<br/>Safety nets]
    D -->|No| F{Can restraint prevent exposure?}
    F -->|Yes| G[Fall Restraint:<br/>Limits movement to prevent<br/>reaching fall hazard]
    F -->|No| H[Personal Fall Arrest System:<br/>Full body harness<br/>Shock-absorbing lanyard<br/>Anchor point]
