...
```mermaid
graph TD
    A[Federal Regulations<br/>EPA, DOE, OSHA] --> B[Model Codes<br/>IMC, UMC, IBC]
    B --> C[State-Adopted Codes<br/>+ State Amendments]
    C --> D[Local Jurisdictions<br/>+ Local Amendments]

    E[Consensus Standards<br/>ASHRAE, NFPA, UL] --> B
    E --> F[Referenced by Code]
    F --> C

    G[Industry Guidelines<br/>SMACNA, ACCA] --> H[Best Practices<br/>Not Legally Binding]

    B -.Referenced.-> E
    C --> I[Code Enforcement<br/>Building Officials]
    D --> I
