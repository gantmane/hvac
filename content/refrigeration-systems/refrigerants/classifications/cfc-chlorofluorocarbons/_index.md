...
**CClₓFᵧ** (for single-carbon compounds)
**C₂ClₓFᵧ** (for two-carbon compounds)
...
CFCs can sensitize the heart to epinephrine, potentially causing cardiac arrhythmia at high concentrations (>10,000 ppm). This effect limits occupational exposures during maintenance activities in confined spaces.
...
CFCs contribute approximately 12% of historical radiative forcing from long-lived greenhouse gases, despite representing a small fraction of emissions by mass.
