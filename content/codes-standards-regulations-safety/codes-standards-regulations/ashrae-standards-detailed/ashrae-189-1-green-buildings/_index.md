...
```mermaid
graph TD
    A[ASHRAE 189.1 Compliance] --> B[Energy Performance]
    A --> C[Water Efficiency]
    A --> D[Indoor Environmental Quality]
    A --> E[Site Sustainability]

    B --> B1[Performance Path:<br/>30% below 90.1 baseline]
    B --> B2[Prescriptive Path:<br/>Enhanced envelope + systems]

    C --> C1[Fixture Requirements:<br/>20% below EPAct 1992]
    C --> C2[Irrigation Efficiency:<br/>50% reduction or elimination]

    D --> D1[Ventilation:<br/>ASHRAE 62.1 + enhanced filtration]
    D --> D2[Thermal Comfort:<br/>ASHRAE 55 compliance]
    D --> D3[Pollutant Control:<br/>Source control + exhaust]

    E --> E1[Heat Island Reduction]
    E --> E2[Stormwater Management]

    B1 --> F[High-Performance<br/>Green Building]
    B2 --> F
    C1 --> F
    C2 --> F
    D1 --> F
...
| **Water Reduction** | 30-40% indoor<br/>50% outdoor | 30% indoor<br/>50% outdoor | 189.1 requirements | 20% indoor reduction |
