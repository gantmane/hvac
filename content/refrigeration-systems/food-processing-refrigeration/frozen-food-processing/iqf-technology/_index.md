...
|-----------|---------------|----------------------|
| Belt width | 600-1200 mm | Product capacity per tier |
| Tier spacing | 200-350 mm | Air flow resistance, total height |
| Spiral diameter | 4-8 m | Footprint, number of tiers |
| Belt speed | 0.5-3.0 m/min | Residence time, capacity |
| Number of tiers | 10-40 | Total residence time |
...
| Belt Type | Temperature Range | Product Applications | Maintenance Requirements |
|-----------|-------------------|---------------------|-------------------------|
| Stainless steel wire mesh | -45 to +100°C | Small pieces, good drainage | Low, resistant to damage |
| Plastic modular | -40 to +80°C | Delicate products, easy cleaning | Moderate, track tension critical |
| Solid stainless belt | -40 to +150°C | Products requiring support | High, requires frequent cleaning |
| PTFE-coated mesh | -45 to +260°C | Sticky products | Moderate, coating can wear |
...
| Parameter | Target Range | Measurement Method | Impact on Quality |
|-----------|--------------|-------------------|-------------------|
| Freezing time | 3-15 minutes | Thermal probe to product center | Crystal size, texture |
| Product temperature | -18 to -20°C | Infrared or contact thermometry | Storage stability |
| Air temperature | -35 to -45°C | RTD sensors in airstream | Heat transfer rate |
| Air velocity | 3-10 m/s | Hot wire or vane anemometer | Heat transfer coefficient |
| Dehydration loss | <0.5-2.0% | Mass balance calculation | Product yield, appearance |
| Free-flow percentage | >95% | Manual separation test | Customer usability |
| Capacity utilization | >85% | Production tracking | Economic efficiency |
