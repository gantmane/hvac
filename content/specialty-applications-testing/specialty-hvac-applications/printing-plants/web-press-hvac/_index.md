...
keywords:
  ...
  - printing plant ventilation
  - solvent vapor control
  - VOC exhaust systems
  - printing facility HVAC
  - dryer heat loads
  - NFPA 86 compliance
  - web offset printing
...
| Load Type | Typical Range | Design Consideration |
|-----------|---------------|---------------------|
| Dryer burner input | 1.5-4.0 MMBtu/hr per press | Size based on web width and speed |
| Radiant heat loss | 15-25% of input | Affects surrounding space loads |
| Exhaust air enthalpy | 60-70% of input | Requires substantial makeup air |
| Product heat absorption | 10-15% of input | Dependent on substrate and coverage |
...
| Parameter | Summer | Winter | Tolerance |
|-----------|--------|--------|-----------|
| Dry-bulb temperature | 75-78°F | 72-75°F | ±2°F |
| Relative humidity | 45-55% | 40-50% | ±5% RH |
| Air velocity | 30-50 FPM | 30-50 FPM | Non-drafting |
