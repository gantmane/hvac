...
keywords:
  ...
  - two-stage HEPA systems
  - DOP testing 99.97%
  - ASME AG-1 filter housing
  ...
  - HEPA filter banks
  - nuclear safety class filtration
date: 2025-01-05
weight: 5
---
...
1. Establish stable aerosol concentration of 80-100 micrograms per liter upstream
2. Scan downstream face of each filter with probe moving 2 inches per second
3. Scan all penetrations, gaskets, and housing seams
4. Document any reading exceeding 0.03% of upstream concentration
5. Repair or replace filters showing penetration above acceptance criteria
