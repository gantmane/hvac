...
```mermaid
graph TD
    A[HVAC Incentive Programs] --> B[Federal Programs]
    A --> C[State Programs]
    A --> D[Utility Programs]
    A --> E[Local Programs]

    B --> B1[25D Tax Credit<br/>Renewables]
    B --> B2[25C Tax Credit<br/>Efficiency Equipment]
    B --> B3[179D Deduction<br/>Commercial Buildings]

    C --> C1[Equipment Rebates<br/>$200-$7,500]
    C --> C2[Tax Credits<br/>10-35% of cost]
    C --> C3[Financing Programs<br/>0-3% APR]

    D --> D1[Electric Utility<br/>Cooling Incentives]
    D --> D2[Gas Utility<br/>Heating Incentives]
    D --> D3[Demand Response<br/>Load Management]

    E --> E1[Municipality Rebates]
    E --> E2[Regional Consortia]
