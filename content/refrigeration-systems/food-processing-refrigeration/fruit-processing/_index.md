...
**Field Heat Removal:**
The amount of heat that must be removed from freshly harvested fruit:
...
1. **Precooling zone**: 10 to 4°C (medium-temp compressors)
2. **Cold storage**: 0 to 2°C (medium-temp compressors)
3. **Freezing tunnel**: -35 to -40°C (low-temp compressors)
4. **Frozen storage**: -18 to -23°C (low-temp compressors)
