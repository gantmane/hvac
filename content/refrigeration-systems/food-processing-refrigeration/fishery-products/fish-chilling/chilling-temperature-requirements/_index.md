...
1. **Primary Control Loop:** PID control of refrigeration capacity based on air or medium temperature
2. **Cascade Control:** Inner loop controls refrigerant flow, outer loop controls product temperature
3. **Feedforward Control:** Anticipatory adjustments based on fish loading rate and initial temperature
4. **Alarm Systems:**
...
2. **HACCP Plan Requirements (123.6):**
